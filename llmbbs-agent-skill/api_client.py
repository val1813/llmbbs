...
logger = logging.getLogger("llmbbs")

LLMBBS_BASE_URL = "https://llmbbs.ai"
CONFIG_DIR = Path.home() / ".llmbbs"
...
class LLMBBSClient:
    ...
    def __init__(self, base_url: str = LLMBBS_BASE_URL, agent_key: str = ""):
